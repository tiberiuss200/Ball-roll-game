...
namespace zzzUnity.Burst.CodeGen
{
    ...
    internal class ILPostProcessing
    {
        ...
        public ILPostProcessing(AssemblyResolver loader, bool isForEditor, ErrorDiagnosticDelegate error, LogDelegate log = null, int logLevel = 0)
        {
            Loader = loader;
        ...
        private MethodDefinition CreateGetFunctionPointerDiscardMethod(TypeDefinition cls, FieldDefinition pointerField, FieldDefinition deferredCompilationField, MethodDefinition burstCompileMethod, MethodDefinition managedFallbackMethod, TypeDefinition injectedDelegate)
        {
        ...
        private void ProcessMethodForDirectCall(MethodDefinition burstCompileMethod)
        {
            ...
            var getFunctionPointerDiscardMethod = CreateGetFunctionPointerDiscardMethod(cls, pointerField, deferredCompilationField, burstCompileMethod, managedFallbackMethod, injectedDelegate);
